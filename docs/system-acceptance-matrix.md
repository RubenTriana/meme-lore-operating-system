...
| Clasificación | PASS WITH LIMITATIONS | Once entidades reales revisadas por módulo y `type` | `npm run validate:canon` | 11/11 coinciden con lo declarado | No prueba verdad narrativa de la prosa | Autor debe aprobar la clasificación semántica |
