...
export function SettingsPage() {
  ...
  const { developerMode, setDeveloperMode, dashboardLayout, setDashboardLayout, aiExtractionEnabled, setAiExtractionEnabled } = useStudioStore()
